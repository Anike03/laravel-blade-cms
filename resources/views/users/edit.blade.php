...
<section class="w3-padding">
    ...
    <form method="post" action="{{ env('APP_URL') }}/console/users/edit/{{$user->id}}" novalidate class="w3-margin-bottom">
    ...
    <a href="{{ env('APP_URL') }}/console/users/list">Back to User List</a>

<?php $__env->startSection('content'); ?>
    ...
    <section class="w3-padding">
        ...
        <form method="post" action="<?php echo e(env('APP_URL')); ?>/console/projects/edit/<?php echo e($project->id); ?>" novalidate
            ...
            <div class="w3-margin-bottom">
                ...
                <select name="type_id" id="type_id">
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->id); ?>" <?php echo e($type->id == old('type_id', $project->type_id) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layout.console', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-blade-cms\resources\views/projects/edit.blade.php ENDPATH**/ ?>